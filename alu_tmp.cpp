...
bool parseline_del_tmp1(string &line, string & output_line, map <int, EmpiricalPdf *> & pdf_rg, float logPE){
  ...
  if (unknowCnt) { 
    ...
    for (int i = 0; i < unknowCnt; i++) {
      ...
      cout << "debug2# " << log10_gp[0] << " " << log10_gp[1] << " " << log10_gp[2] << endl;   
    }
  }  
...
int main( int argc, char* argv[] )
{
  ...
  if ( opt == "write_tmps_pn" ) { 
    ...
    */
  ...
  } else if (opt == "debug1") { // debugging and manually check some regions 
    ...
    line = "chr21 34850160 34850464 23 65 0 9 0:480 0:764 0:763 0:773 0:471 0:502 0:785 0:785 0:497";
